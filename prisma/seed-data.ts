...
export const SPREAD: Record<string, Record<string, number>> = {
  a1: { "디지털L&D센터": 24, 연금기획팀: 8, 해외주식팀: 6 },
  a2: { 법무팀: 28, WM추진팀: 8, 디지털상품기획팀: 6 },
  a3: { 플랫폼개발팀: 32 },
  a4: { WM추진팀: 25, 법무팀: 10, 경영관리팀: 10 },
  a5: { 해외주식팀: 18, "디지털L&D센터": 10 },
  a6: { "디지털L&D센터": 26 },
  a7: { WM추진팀: 24, 연금기획팀: 12 },
  a8: { 해외주식팀: 25, IB1팀: 10, 상품전략팀: 7 },
  a9: { 연금기획팀: 34 },
  a10: { 해외주식팀: 16, 법무팀: 6, IB1팀: 6 },
  a11: { 디지털상품기획팀: 32 },
  a12: { 플랫폼개발팀: 28, "디지털L&D센터": 10, 경영관리팀: 7 },
  a13: { IB1팀: 20, 법무팀: 5, 경영관리팀: 5 },
  a14: { 상품전략팀: 25, WM추진팀: 7, 디지털상품기획팀: 6 },
  a15: { 경영관리팀: 23, 플랫폼개발팀: 6, 상품전략팀: 6 },
  a16: { 연금기획팀: 18, 해외주식팀: 8 },
  a17: { WM추진팀: 22, 연금기획팀: 6, 디지털상품기획팀: 5 },
  a18: { 법무팀: 25, "디지털L&D센터": 8, 경영관리팀: 7 },
  a19: { 경영관리팀: 24 },
  a20: { IB1팀: 21, 해외주식팀: 5, 상품전략팀: 5 },
  a21: { 플랫폼개발팀: 18, 디지털상품기획팀: 6, "디지털L&D센터": 5 },
  a22: { "디지털L&D센터": 14, 연금기획팀: 8 },
};
